...
4. [Lesson 4: Waveform and Timbre](book/lesson-04-waveform-and-timbre.md) adds waveform selection to the oscillator.
5. [Lesson 5: Low-Pass Filter](book/lesson-05-low-pass-filter.md) adds a filter after Gain.
6. [The course map](book/course-map.md) records the module, jack, and cable order for the growing board.
