...
2. Lesson 2 adds the pitch-control module and its patch cable to the oscillator.
...
7. Lesson 7 will add a filter module to the path that leads to the audio output.
8. Lesson 8 will add a low-frequency oscillator and its patch cable.
